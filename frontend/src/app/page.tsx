...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      {/* Hero */}
      <section className="bg-[#1A3C5E] py-16 px-4 text-center">
        <h1 className="text-4xl font-bold text-white mb-3">Cogitons</h1>
        <p className="text-[#2E6DA4] text-lg max-w-xl mx-auto">
      ...
      <section className="max-w-3xl mx-auto px-4 py-10">
        <h2 className="text-xl font-semibold text-[#1A3C5E] mb-6">
          Browse Subjects
        </h2>

...
DiscussionStatusEnum = Enum(
    "published", "locked", "removed", name="discussion_status", create_type=False
)
...
class Discussion(Base):
    ...
    status: Mapped[str] = mapped_column(
        DiscussionStatusEnum, nullable=False, default="published", index=True
    )
